...
package net.enderman999517.tutorialmod.entity.client;

import net.enderman999517.tutorialmod.entity.animation.ModAnimations;
...
public class PorcupineModel<T extends PorcupineEntity> extends SinglePartEntityModel<T> {
	...
	private void setHeadAngles(float headYaw, float headPitch) {
		...
		headPitch = MathHelper.clamp(headPitch, -25f, 25f);
