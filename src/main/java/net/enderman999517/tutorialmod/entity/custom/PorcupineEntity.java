...
import net.enderman999517.tutorialmod.entity.ai.PorcupineAttackGoal;
...
public class PorcupineEntity extends AnimalEntity {
    ...
    protected void initGoals() {
        ...
        this.goalSelector.add(1, new PorcupineAttackGoal(this, 2D, true));

        this.goalSelector.add(1, new AnimalMateGoal(this, 1.15D));
        this.goalSelector.add(2, new TemptGoal(this, 2D, Ingredient.ofItems(Items.BEETROOT), false));
